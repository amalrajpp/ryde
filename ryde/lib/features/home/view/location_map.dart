...
class _LocationMapState extends State<LocationMap> {
  ...
  Future<Uint8List> _createCarMarkerBytes(
    int number, {
    int diameter = 140,
  }) async {
    ...
    final Paint circlePaint = Paint()
      ..color = const Color(0xFFDBECFF); // light blue background
    ...
    final TextPainter carPainter = TextPainter(
    ...
    final Offset carOffset = Offset(
      center - carPainter.width / 2,
      center - carPainter.height / 2,
    );
    ...
    final Offset badgeCenter = Offset(
      center + diameter * 0.26 - badgeRadius,
      center - diameter * 0.26 + badgeRadius,
    );
    ...
    final Offset numberOffset = Offset(
              ...
              Marker(
                ...
                infoWindow: InfoWindow(
                  ...
                  snippet: data['vehicle'] != null
                      ? "${data['vehicle']['model'] ?? ''} ${data['vehicle']['color'] ?? ''}"
                            .trim()
                      : null,
                ),
                onTap: () {
